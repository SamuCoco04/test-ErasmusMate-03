...
| Phase 7B Institutional UI polish | Student/Coordinator/Admin | UI contract (Vitest) | Institutional page-shell hierarchy, route links, and action affordances remain visible after UI polish | Headings/components/routes remain present and safe attachment affordances are retained | Implemented |
| Phase 7B Institutional notifications UX | Student/Coordinator/Admin | UI contract (Vitest) | Institutional notifications screens use shared PageShell/PageHeader layout and preserve role-specific activity visibility | Notification pages keep shared structure and role-focused headings | Implemented |
