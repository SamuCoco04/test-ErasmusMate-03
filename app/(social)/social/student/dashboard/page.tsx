...
export default async function SocialStudentDashboardPage() {
  ...
  return <div className='space-y-6'>
    ...
    <div className='grid gap-4 md:grid-cols-2'>
      ...
      <DashboardCard title='Map discovery' description='Browse city-level student discovery points with safe visibility rules.' status='Available now' action={<ButtonLink href='/social/student/map' variant='secondary'>Open map discovery</ButtonLink>} />
