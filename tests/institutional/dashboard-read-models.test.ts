...
describe('institutional read models', () => {
  ...
  it('coordinator risk classification includes medium and low cases', async () => {
    ...
    await prisma.mobilityRecord.upsert({ where: { id: 'mobility-medium' }, update: {}, create: { id: 'mobility-medium', studentId: 'student-medium', coordinatorId: 'coordinator-1', homeInstitutionId: 'inst-home-1', hostInstitutionId: 'inst-host-1', mobilityStatus: 'PENDING', startDate: new Date('2026-09-01T00:00:00.000Z'), endDate: new Date('2027-01-31T00:00:00.000Z') } });
    await prisma.mobilityRecord.upsert({ where: { id: 'mobility-low' }, update: {}, create: { id: 'mobility-low', studentId: 'student-low', coordinatorId: 'coordinator-1', homeInstitutionId: 'inst-home-1', hostInstitutionId: 'inst-host-1', mobilityStatus: 'PENDING', startDate: new Date('2026-09-01T00:00:00.000Z'), endDate: new Date('2027-01-31T00:00:00.000Z') } });
